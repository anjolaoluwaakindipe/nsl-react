...
function LoanBalanceCard(prop:LoanBalanceCardProp) {
    return (
        <div className="flex flex-col space-y-3  bg-white px-7 py-5  ">
            ...
            <span className=" text-primaryColor text-xs inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline bg-gray-200  rounded-full float-right">
                 {prop.days} </span>
