...
function Information() {
    return (
        <form
            action="/"
            className="  w-full py-20 space-y-16text-darkTextColor overflow-x-scroll"
        >
            <div className="space-y-5 pt-10 ">
                <h1 className="heading1 text-primaryColor">Loan Description </h1>
            </div>

            <div className=" grid grid-cols-4 gap-20 pt-8  border-b-2  border-underlineColor w-full">
