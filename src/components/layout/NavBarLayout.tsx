    ...
    return (
        <div>
            <div className="w-full py-5 shadow-2xl">
                <div className="md:max-w-5xl m-auto w-full px-5 md:px-0 flex items-center justify-between">
                    <div>
                    <img src="assets/companylogo1.svg" alt="logo" className="object-contain " />
                    </div>
